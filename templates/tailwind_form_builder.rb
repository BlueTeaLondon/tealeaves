  ...
  module Builders
    class TailwindFormBuilder < SimpleForm::FormBuilder
      ...
      def input(attribute_name, options = {}, &block)
        ...
        input_class = "block w-full rounded-md border-0 py-1.5 text-gray-900 shadow-sm ring-1 ring-inset ring-gray-300 dark:ring-white/10 placeholder:text-gray-400 focus-within:ring-2 focus-within:ring-inset focus-within:ring-blue-600 sm:text-sm sm:leading-6 dark:bg-white/5 dark:focus-within:ring-blue-600"
        ...
        case options[:as]
        when :boolean
          input_class = "focus:ring-blue-500"
      ...
      def label(attribute_name, *args, &block)
        ...
        default_class = "block text-sm font-medium dark:text-white"
      ...
      def button(type, *args, &block)
        ...
        default_classes = "rounded-md bg-white dark:bg-white/10 px-4 py-2 text-sm font-semibold text-white shadow-sm hover:bg-gray-50 dark:hover:bg-white/20 cursor-pointer"
      ...
      def submit(value = nil, options = {})
        default_classes = "rounded-md bg-blue-600 px-4 py-2 text-sm font-semibold text-white shadow-sm hover:bg-blue-500 focus-visible:outline focus-visible:outline-2 focus-visible:outline-offset-2 focus-visible:outline-blue-600 cursor-pointer"
