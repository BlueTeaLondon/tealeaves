...
RSpec.describe Tealeaves::Production::ManifestGenerator, type: :generator do
  ...
  describe "invoke" do
    it "generates the manifest for a production build" do
      with_fake_app do
        ...
        invoke! Tealeaves::Production::ManifestGenerator
  ...
  describe "revoke" do
    it "destroys the manifest for a production build" do
      with_fake_app do
        ...
        invoke_then_revoke! Tealeaves::Production::ManifestGenerator
