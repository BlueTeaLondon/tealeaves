...
RSpec.describe Tealeaves::Production::DeploymentGenerator, type: :generator do
  ...
  describe "invoke" do
    it "generates a bin/deploy binary" do
      with_fake_app do
        ...
        invoke! Tealeaves::Production::DeploymentGenerator
  ...
  describe "revoke" do
    it "destroys the bin/deploy binary" do
      with_fake_app do
        ...
        invoke_then_revoke! Tealeaves::Production::DeploymentGenerator
