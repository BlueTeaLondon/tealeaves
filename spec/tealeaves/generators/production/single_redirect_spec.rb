...
RSpec.describe Tealeaves::Production::SingleRedirect, type: :generator do
  describe "invoke" do
    it "adds Rack::CanonicalHost to the production middleware" do
      with_fake_app do
        invoke! Tealeaves::Production::SingleRedirect
  ...
  describe "revoke" do
    it "removes Rack::CanonicalHost from the production middleware" do
      with_fake_app do
        invoke_then_revoke! Tealeaves::Production::SingleRedirect
