...
RSpec.describe Tealeaves::DbOptimizationsGenerator, type: :generator do
  describe "invoke" do
    it "bundles the bullet gem" do
      with_fake_app do
        invoke! Tealeaves::DbOptimizationsGenerator
  ...
  describe "revoke" do
    it "removes the bullet gem from Gemfile" do
      with_fake_app do
        invoke_then_revoke! Tealeaves::DbOptimizationsGenerator
