...
RSpec.describe Tealeaves::AccessibilityGenerator, type: :generator do
  describe "invoke" do
    it "bundles the capybara_accessibility_audit gem" do
      with_fake_app do
        invoke! Tealeaves::AccessibilityGenerator
  ...
  describe "revoke" do
    it "removes the gems from Gemfile" do
      with_fake_app do
        invoke_then_revoke! Tealeaves::AccessibilityGenerator
